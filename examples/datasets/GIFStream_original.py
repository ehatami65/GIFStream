...
class Parser:
    ...
    def __init__(
        ...
        self.campaths = [os.path.join(data_dir, "undistort", x) for x in sorted(os.listdir(os.path.join(data_dir, "undistort")))]
...
class Dataset:
    ...
    def __init__(
        ...
        if split == "train":
            self.indices = indices#[x for x in indices if (x // GOP_size) not in test_set]
        else:
    ...
    def __getitem__(self, item: int) -> Dict[str, Any]:
        ...
        # print(f"[DEBUG] data_dir: {self.parser.data_dir}, image_path: {image_path}")
